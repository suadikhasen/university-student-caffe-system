...
<div class="container" style="margin-top: 150px;">
		...
		@endif
	<h1 style="background-color: green;text-align:center;">Adding User</h1>
	  <form method="post" action=" {{ route('add_user_control') }} ">
	  	 
			<div class="form-group">
				<input type="text" name="name" placeholder="user's name" required="required" class="form-control" autofocus="autofocus">

			</div>

			<div class="form-group">
				<input type="text" name="username" placeholder="user's username" required="required" class="form-control">
			</div>
	        <div class="form-group">
	        	<input type="password" name="password" placeholder="user's password" required="required" class="form-control">
